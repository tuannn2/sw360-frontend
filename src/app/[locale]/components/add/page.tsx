...
export default function Summary() {
    ...
    const selectVendor = () => {
        console.log("--------------------------");
        <SearchVendorsModalComponent chooseVendor={null} />
                                ...
                                <div className="row mb-4">
                                    ...
                                    <div className="col-lg-4">
                                        ...
                                        <div className="col-lg-4">
                                            ...
                                            readOnly={true} name = "defaultVendorId" onChange={updateField} value={componentPayload.defaultVendorId} 
                                            onClick={selectVendor}/> <div id="default_vendor" className="form-text"><i className="bi bi-x-circle"></i></div>
                                        </div>
                                        <div className="col-lg-4">
